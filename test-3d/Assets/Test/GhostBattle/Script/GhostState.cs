...
public class GhostData
{
    ...
    public int manaBolusDropAmount = 5;           // 掉落魔法值的数量
    public float manaBolusDropChance = 1f;        // 掉落概率 (0-1)
    
    [Tooltip("其他掉落物配置")]
    public List<DropItemConfig> otherDrops;       // 其他掉落物列表
    
    [Tooltip("死亡时生成的场景物体")]
    public List<SpawnObjectConfig> spawnObjects;  // 死亡时生成的场景物体
}
