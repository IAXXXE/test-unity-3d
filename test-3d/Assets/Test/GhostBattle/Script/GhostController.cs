...
public class GhostController : MonoBehaviour, IDamageable
{
    ...
    private void InitializeGhost(int id)
    {
        ...
        vfxController.explosiveEffect = explosiveVFXPrefab;
        ...
        OnExplosive += HandleExplosiveExecuted;
    ...
    public void TakeDamage(DamageInfo damageInfo)
    {
        ...
        if(damageInfo.attacker == this.gameObject) return;
    ...
    private void HandleExplosiveExecuted()
    {
        vfxController?.PlayExplosiveEffect();
    }
    ...
    private IEnumerator DelayedReturn()
    {
        ...
        // 掉落物
        if (GhostDropManager.Instance != null && stat != null)
        {
            GhostDropManager.Instance.HandleGhostDrop(
                stat.data,
                transform.position,
                transform.rotation
            );
